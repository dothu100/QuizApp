...
class QuestionAdapter(
    ...
    val onAnswered: () -> Unit // Thêm callback để chuyển sang câu hỏi tiếp theo
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
        ...
        // Cập nhật màu sắc đáp án đúng và sai
        ...
        holder.itemView.setOnClickListener {
            ...
            // Cập nhật giao diện và điểm số sau khi chọn đáp án
            ...
            // Tự động chuyển sang câu hỏi tiếp theo sau khi chọn đáp án
            onAnswered()  // Gọi callback để chuyển câu hỏi
        }
