...
class QuestionActivity : AppCompatActivity(), QuestionAdapter.score {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rightArrow.setOnClickListener {
            ...
            binding.questionNumberTxt.text = "Question ${binding.progressBar.progress}/10"
        ...
        binding.leftArrow.setOnClickListener {
            if (binding.progressBar.progress == 1) {
                return@setOnClickListener
            }
            position--
            binding.progressBar.progress = binding.progressBar.progress - 1
    ...
    private fun loadAnswers() {
        ...
        val questionAdapter by lazy {
            QuestionAdapter(
                ...
                onAnswered = {
                    // Trì hoãn việc chuyển câu hỏi để người dùng thấy kết quả
                    Handler().postDelayed({
                        nextQuestion() // Chuyển câu hỏi sau một khoảng thời gian
